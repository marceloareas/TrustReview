...
export const products: IProduct[] = [
  {
    ...
    name: "Product 1",
    description:
      "Description for Product 1 lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Description for Product 1 lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Description for Product 1 lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Description for Product 1 lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Description for Product 1 lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Description for Product 1 lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    tags: [
      { id: "1", name: "Tag 1" },
      { id: "2", name: "Tag 2" },
    ],
    ...
    reviews: [
      ...
      },
      {
        ...
        cons: "Acabou rápido",
        rating: 4,
        comment: "Gostei bastante, mas poderia durar mais.",
        likeCount: 2,
        dislikeCount: 4,
      ...
      },
      {
        ...
        title: "Regular",
        pros: "Entrega rápida",
        cons: "Pouco eficiente",
        rating: 3,
        comment: "Esperava mais pelo preço.",
        likeCount: 3,
        dislikeCount: 5,
      ...
      },
      {
        ...
        pros: "Preço ótimo",
        cons: "Tampa difícil de abrir",
        rating: 5,
        comment: "Voltaria a comprar com certeza.",
        likeCount: 2,
        dislikeCount: 1,
        createdAt: new Date("2025-09-01T12:00:00Z"),
        updatedAt: new Date("2025-09-01T12:10:00Z"),
      },
      {
        id: "r6",
        userId: "u6",
        ...
        userName: "Fábio",
        title: "Não gostei",
        pros: "Embalagem bonita",
        cons: "Não funcionou bem",
        rating: 2,
        comment: "Não recomendo, não atendeu minhas expectativas.",
        likeCount: 1,
        dislikeCount: 2,
      ...
      },
      {
        ...
        userName: "Gabriela",
        title: "Produto bom",
        pros: "Cheiro agradável",
        cons: "Pouco rendimento",
        rating: 4,
        comment: "Gostei, mas poderia render mais.",
        likeCount: 3,
        dislikeCount: 1,
      ...
      },
      {
        ...
        userName: "Henrique",
        title: "Satisfeito",
        pros: "Entrega no prazo",
        cons: "Preço um pouco alto",
        rating: 4,
        comment: "No geral, recomendo.",
        likeCount: 2,
        dislikeCount: 3,
        createdAt: new Date("2025-09-01T13:30:00Z"),
        updatedAt: new Date("2025-09-01T13:40:00Z"),
      },
    ],
    ...
    reviews: [
      {
        ...
        likeCount: 4,
        dislikeCount: 2,
        createdAt: new Date("2025-09-03T12:10:00Z"),
        updatedAt: new Date("2025-09-03T12:20:00Z"),
      },
    ],
    ...
    reviews: [
      {
        ...
        likeCount: 2,
        dislikeCount: 3,
        createdAt: new Date("2025-09-05T14:10:00Z"),
        updatedAt: new Date("2025-09-05T14:20:00Z"),
      },
      {
        id: "r11",
        userId: "u5",
        ...
        updatedAt: new Date("2025-09-05T14:40:00Z"),
      },
      {
        id: "r12",
        userId: "u6",
        ...
        likeCount: 0,
        dislikeCount: 0,
        createdAt: new Date("2025-09-05T14:50:00Z"),
        updatedAt: new Date("2025-09-05T15:00:00Z"),
      },
    ],
