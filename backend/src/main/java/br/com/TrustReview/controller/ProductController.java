 ...
 *
 * <p>
 * Disponibiliza operações REST para criação, consulta, atualização, remoção e busca de produtos relacionados,
 ...
 *   <li><b>getAll</b>: Lista todos os produtos, podendo incluir tags associadas.</li>
 *   <li><b>getRelatedProducts</b>: Busca produtos relacionados por tags compartilhadas.</li>
...
public class ProductController {
     ...
     * @param include Indica se deve incluir as tags associadas aos produtos na resposta
    ...
    @GetMapping
    public ResponseEntity<List<ProductResponseDTO>> getAll(@RequestParam(name = "includeTags", required = false, defaultValue = "false") boolean include) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Produtos relacionados encontrados com sucesso",
                    content = @Content(array = @ArraySchema(schema = @Schema(implementation = ProductPageDTO.class)))),
            @ApiResponse(responseCode = "404", description = "Produto não encontrado",
                    content = @Content(schema = @Schema(implementation = ApiError.class))),
            @ApiResponse(responseCode = "500", description = "Erro interno do servidor",
                    content = @Content(schema = @Schema(implementation = ApiError.class)))
