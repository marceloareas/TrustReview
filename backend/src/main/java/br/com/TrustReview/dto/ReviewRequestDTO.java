...
public class ReviewRequestDTO {
    ...
    @NotBlank(message = "É necessário um mínimo de 0 likes para a avaliação sendo obrigatório")
    @Min(0)
    @Schema(description = "Quantidade de curtidas recebidas na avaliação.", example = "42")
    private int likes;

    @NotBlank(message = "É necessário um mínimo de 0 dislikes para a avaliação sendo obrigatório")
    @Min(0)
